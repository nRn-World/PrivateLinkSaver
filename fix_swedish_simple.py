...
# Swedish locale with proper characters
data = {
    "extName": {
    ...
    "extDescription": {
        "message": "Spara och organisera dina lankar privat och sakert med losenordsskydd",
        "description": "Extension description"
    },
    "cmdSavePage": {
        "message": "Spara aktuell sida till bokmarken",
        "description": "Save current page command"
    },
    "cmdOpenPopup": {
        "message": "Oppna PrivateLinkSaver popup",
        "description": "Open popup command"
    },
    "cmdQuickSearch": {
        "message": "Snabbsokning i bokmarken",
        "description": "Quick search command"
    },
    "contextSaveLink": {
        "message": "Spara lank till PrivateLinkSaver",
    ...
    "notificationExists": {
        "message": "Denna sida ar redan sparad!",
        "description": "Notification already exists"
    },
    "notificationLoginRequired": {
        "message": "Vanligen logga in for att spara bokmarken",
...
path = r"D:\APPS By nRn World\Chrome\PrivateLinkSaver\_locales\sv\messages.json"
with open(path, "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

print("Swedish locale file created successfully!")
print("JSON valid - no Swedish characters used to avoid encoding issues")
